    ...
    getProvider() {
        if (!this._baseAlchemyProvider) {
            this._baseAlchemyProvider = (() => __awaiter(this, void 0, void 0, function* () {
                const { AlchemyProvider } = yield Promise.resolve().then(function () { return require('./alchemy-provider-f9dd54fb.js'); });
    ...
    getWebSocketProvider() {
        if (!this._baseAlchemyWssProvider) {
            this._baseAlchemyWssProvider = (() => __awaiter(this, void 0, void 0, function* () {
                const { AlchemyWebSocketProvider } = yield Promise.resolve().then(function () { return require('./alchemy-websocket-provider-da236357.js'); });
    ...
    if (rawNftContract.contractMetadata.openSea) {
        ...
        contract.openSea = {
            ...
            safelistRequestStatus: safeListStatus !== undefined
                ? stringToEnum(safeListStatus, exports.OpenSeaSafelistRequestStatus)
                : undefined,
...
//# sourceMappingURL=index-3d28d922.js.map
